...
##Joining states_polygon with death_total to prepare for total deaths 
##per state plot
...
##Creates a dataframe with total number of deaths by state that can be 
##joined with states_sf
...
##Joins the states_sf dataset for mapping with the death_total_upper
##dataframe to find total number of deaths by state in an interactive map
...
##Joins the states_polygon mapping dataset with the death_order_lower
##dataframe created about leading cause of death
...
##Interactive Plot for Leading Cause of Death
```{r}
##Creates dataframe with most common cause of death by state that can be
##joined with states_sf
